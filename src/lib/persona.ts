...
export const PERSONAS: Record<PersonaId, PersonaDef> = {
  student: {
    ...
    emoji: '🎓',
    tabOrder: ['topics', 'notes', 'frameworks', 'bias', 'quotes'],
    hiddenTabs: ['debate'],
    defaultTab: 'topics',
  ...
  researcher: {
    ...
    emoji: '🔬',
    tabOrder: ['quotes', 'research', 'bias', 'debate', 'topics', 'frameworks'],
    hiddenTabs: ['notes'],
    defaultTab: 'quotes',
  ...
  general: {
    ...
    emoji: '🧠',
    tabOrder: ['topics', 'debate', 'frameworks', 'bias', 'quotes', 'notes', 'research'],
    hiddenTabs: [],
    defaultTab: 'topics',
